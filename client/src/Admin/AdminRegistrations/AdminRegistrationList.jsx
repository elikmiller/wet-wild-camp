...
class AdminRegistrationList extends Component {
    ...
    getRegistrations = () => {
        ...
        appClient.adminGetRegistrations(this.state.displayArchived).then(registrations => {
            this.setState({
                registrations,
                isLoading: false,
                default: {
                    ...
                    columns={[
                        {
                            key: "user.lastName",
                            name: "User",
                            displayFunc: item => item.user && `${item.user.firstName} ${item.user.lastName}`
                        },
                        {
                            key: "camp.fullName",
                            name: "Camp",
                        ...
                        },
                        {
                            ...
                            displayFunc: item => {
                                return (
                                    <div>
                                        {item.paid && <span className="badge badge-success">Paid in Full</span>}
                        ...
                        },
                        {
                            key: "",
                            name: "",
                            displayFunc: item => <Link to={`/admin/registrations/${item._id}`}>Details</Link>
                        }
                    ]}
                />
            </div>
