...
class AdminUserDetail extends Component {
    ...
    createCamper = ({ firstName, lastName, gender, dateOfBirth, swimmingStrength, notes }) => {
        return appClient
            .adminCreateCamper({
            ...
            <div className="admin-user-detail">
                <div className="card">
                        ...
                        <div className="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <UncontrolledDropdown>
                                    ...
                                    <DropdownMenu right>
                                        <DropdownItem onClick={this.openAddCamper}>Add Camper</DropdownItem>
                                        <DropdownItem onClick={this.openDeleteUser}>Delete User</DropdownItem>
                                    </DropdownMenu>
                                </UncontrolledDropdown>
                            </div>
                        </div>
                    ...
                    <div className="card-body">
                        <div className="mb-3">
                            <strong>User: </strong>
                            <AdminUser firstName={user.firstName} lastName={user.lastName} email={user.email} />
                        </div>
                        ...
                        <div className="mb-3">
                            ...
                            <ul className="list-unstyled">
                                {this.state.user.campers.map((camper) => (
                                    <li key={camper._id}>
                                        <Link to={`/admin/campers/${camper._id}`}>{camper.fullName}</Link>
                                    </li>
                                ))}
                            </ul>
                        </div>
                ...
                <Modal isOpen={this.state.camperAddOpen} toggle={this.closeAddCamper}>
                    ...
                    <ModalBody>
                        <AdminCamperForm onSubmit={this.createCamper} closeForm={this.closeAddCamper} />
                    </ModalBody>
                </Modal>
                <Modal isOpen={this.state.deleteUserOpen} toggle={this.closeDeleteUser}>
                    ...
                    <ModalBody>
                        <p className="mt-2 mb-4">
                            Are you sure you want to delete this user? This will also delete all associated
                            registration, camper, and payment data.
                        </p>
                        <button className="btn btn-outline-secondary mr-3" onClick={this.closeDeleteUser}>
                            Cancel
                        </button>
