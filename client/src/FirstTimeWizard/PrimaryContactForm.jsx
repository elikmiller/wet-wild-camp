...
class PrimaryContactInformationForm extends Component {
    ...
    validate = () => {
        ...
        if (validator.isEmpty(this.state.lastName + "")) errors.lastName = "Last name is required.";
        if (!validator.isMobilePhone(this.state.phoneNumber + ""))
            errors.phoneNumber = "Please enter a valid phone number.";
        if (validator.isEmpty(this.state.phoneNumber + "")) errors.phoneNumber = "Phone number is required.";
        if (!validator.isEmail(this.state.email + "")) errors.email = "Please enter a valid email address.";
        if (validator.isEmpty(this.state.email + "")) errors.email = "Email address is required.";
        if (validator.isEmpty(this.state.streetAddress + "")) errors.streetAddress = "Address is required.";
        if (validator.isEmpty(this.state.city + "")) errors.city = "City is required.";
        if (validator.isEmpty(this.state.state + "")) errors.state = "State is required.";
        if (validator.isEmpty(this.state.zipCode + "")) errors.zipCode = "Zip code is required.";
        return errors;
    };
        ...
        return (
            <div className="primary-contact-information-form contact-information-form">
                ...
                <div className="alert alert-dark" role="alert">
                    ...
                    <hr />
                    <p className="mb-0">Let's get started by filling out your contact information.</p>
                </div>
                <p>
